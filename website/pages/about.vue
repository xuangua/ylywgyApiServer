        ...
        <div class="about-box">
            <div class="about-main">
                ...
                <div class="about-center">
                    ...
                    <p class="about-text">golang中文社区的所有代码都是<em>开源</em>的, 项目名为<em>golang123</em>, github地址为<a href="https://github.com/xuangua/ylywgyApiServer" target="_blank">https://github.com/xuangua/ylywgyApiServer</a><br/>golang123的技术架构是前后端分离的, 前端使用vue、iview、node.js、nuxt等技术来开发, 后端使用go、gin、gorm等技术来开发。golang123的技术选型也是超前的, 我们大胆得使用nuxt来做<em>前后端同构渲染</em>。</p>
